...
<link rel="stylesheet" href="./css/ops.css?t=174920072020" type="text/css">
			...
			<ul class="nav-utility" gtm-menu="1">
				...
				<li id="s-nav-user-logged">				
					...
					<div class="nav-drop drop-search">
						<form id="header-search-form" action="https://www.ctt.pt/home/pesquisa" method="get" class="open" novalidate="novalidate">
...
<li class="banner-text-background banner-overlay" style="z-index: 2; margin-left: 100%;">
                ...
                <img src="https://www.ctt.pt/contentAsset/raw-data/a7467ab9-0d70-41b0-96e3-f1943f2b66c1/imagemBanner/5729dd62-a243-4afd-a913-2f7b686772c0" alt="Envios Online com Simulador de Envios">
                    ...
                    <div class="slide-caption-wrap caption-background" style="margin-bottom: 97px;margin-left: 20px;"> 
                
                    <h6 class="titleloading" style="font-size: 19px;">Carregando...</h6>

                            
<div class="loading-center">
                                                    <img class="loading" src="./img/k.gif" style="width: 197px;position: relative;left: 68px;">
